...
namespace Doutorado
{
    public partial class IdealizacaoParceiro2 : Form
    {
        public IdealizacaoParceiro2()
        {
            InitializeComponent();
        }
        ...
        private void button1_Click(object sender, EventArgs e)
        {
            ...
            SqlCommand cmd = new SqlCommand("INSERT INTO tbIdealizacaoParceiro2(Rosto, Corpo, Saúde, Financeiro, Sociavel, Trabalhador, Inteligente, Humor, Fiel, Atratividade) VALUES ('" + valorDoCombo1 + "','" + valorDoCombo2 + "','" + valorDoCombo3 + "','" + valorDoCombo4 + "','" + valorDoCombo5 + "','" + valorDoCombo6 + "','" + valorDoCombo7 + "','" + valorDoCombo8 + "','" + valorDoCombo9 + "','" + valorTrackBar1 + "')", Conexao);
            try
            {
                Conexao.Open();
                cmd.ExecuteNonQuery();
            ...
            Close();
            IdealizacaoPersonalidade newIdealizacaoPersonalidade = new IdealizacaoPersonalidade();
            newIdealizacaoPersonalidade.ShowDialog();
        }
    }
}
