...
namespace Doutorado
{
    public partial class PersonalidadeCasal : Form
    {
        public PersonalidadeCasal()
        {
            InitializeComponent();
        }
