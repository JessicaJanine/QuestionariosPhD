...
namespace Doutorado
{
    public partial class PersonalidadeParceiro : Form
    {
        public PersonalidadeParceiro()
        {
            InitializeComponent();
        }
        ...
        private void button1_Click(object sender, EventArgs e)
        {
            ...
            Close();
            Agradecimento newAgradecimento = new Agradecimento();
            newAgradecimento.ShowDialog();
        }
    }
}
