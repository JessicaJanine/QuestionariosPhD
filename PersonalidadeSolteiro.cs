...
namespace Doutorado
{
    public partial class PersonalidadeSolteiro : Form
    {
        public PersonalidadeSolteiro()
        {
            InitializeComponent();
        }
        ...
        private void button1_Click(object sender, EventArgs e)
        {
            ...
            Close();
            ApegoSolteiro newApegoSolteiro = new ApegoSolteiro();
            newApegoSolteiro.ShowDialog();
        }
    }
}
